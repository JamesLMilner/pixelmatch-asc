...
export function pixelmatch(
	...
	let diff: i32 = 0;
	const aaR: i8 = aaColor[0] || 255 as i8;
	const aaG: i8 = aaColor[1] || 255 as i8;
	const aaB: i8 = aaColor[2] || 0 as i8;

	const diffR: i8 = diffColor[0] || 255 as i8;
	const diffG: i8 = diffColor[1] || 0 as i8;
	const diffB: i8 = diffColor[2] || 0 as i8;
...
function rgb2y(r: i8, g: i8, b: i8): f32 { 
	return ((r as f32) * 0.29889531 + (g as f32) * 0.58662247 + (b as f32) * 0.11448223); 
}
function rgb2i(r: i8, g: i8, b: i8): f32 { 
	return ((r as f32) * 0.59597799 - (g as f32) * 0.27417610 - (b as f32) * 0.32180189);
}
function rgb2q(r: i8, g: i8, b: i8): f32 { 
	return ((r as f32) * 0.21147017 - (g as f32) * 0.52261711 + (b as f32) * 0.31114694);
}

// blend semi-transparent color with white
function blend(c: i8, a: i8): i8 {
	return (255 as i8) + (c - 255 as i8) * a;
}

function drawPixel(output: Int8Array, pos: i32, r: i32, g: i32, b: i32): void {
	output[pos] = r;
	output[pos + 1] = g;
	output[pos + 2] = b;
	output[pos + 3] = 255;
...
function drawGrayPixel(img: Int8Array, i: i32, alpha: f32, output: Int8Array): void {
	const r: i8 = img[i + 0];
	const g: i8 = img[i + 1];
	const b: i8 = img[i + 2];

	const c1: i8 = rgb2y(r, g, b) as i8;
	const c2: i8 = (((0.1 as f32) * ((img[i + 3] / 255) as f32)) as i8);
